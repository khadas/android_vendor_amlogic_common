...
*  Portions copyright 2019-2021 Amlogic
*
...
/*If TRUE,then when btwrite is assert, after PROC_BTWRITE_TIMER_TIMEOUT_MS
 * btwrite will be deassert in proc_btwrite_timeout().*/
#ifndef BTWRITE_ASSERT_TIMER
#define BTWRITE_ASSERT_TIMER FALSE
#endif
