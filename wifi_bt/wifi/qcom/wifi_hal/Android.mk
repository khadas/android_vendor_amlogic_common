...
LOCAL_MODULE := libwifi-hal-qcom-aml
LOCAL_VENDOR_MODULE := true
LOCAL_CLANG := true
LOCAL_SHARED_LIBRARIES += libnetutils liblog libwpa_client libcld80211-aml
...
LOCAL_SHARED_LIBRARIES += libdl libwpa_client libcld80211-aml
