...
private:
    TwtCapability parseTwtCap(uint32_t twt_peer_cap) {
        ...
        cap.flexibile_twt_supported = (twt_peer_cap & WL_TWT_CAP_FLAGS_FLEX_SUPPORT) ? 1 : 0; //google code is flexibile_twt_supported at /hardware/libhardware_legacy/include/hardware_legacy/wifi_twt.h
        return cap;
    }
