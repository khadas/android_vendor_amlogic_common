...
static const dongle_info dongle_registerd[]={\
    ...
    {"02d0","0000","dhd","/vendor/lib/modules/dhd.ko","firmware_path=/vendor/etc/wifi/4359/fw_bcm4359c0_ag.bin nvram_path=/vendor/etc/wifi/4359/nvram_ap6398s.txt","bcm6389s",0x0,"/vendor/etc/wifi/4359/fw_bcm4359c0_ag","",true,true},\
