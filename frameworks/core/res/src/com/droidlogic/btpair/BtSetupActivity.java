...
public class BtSetupActivity extends Activity implements BluetoothDevicePairer.EventListener{
   ...
   protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (mDefaultBtRemoteType.contains("Amlogic_RC_B10")) {
            remoteImg.setImageDrawable(mContext.getDrawable(R.drawable.remote_press_light_b10));
            mTextStatus.setText(STR_TIP_B10);
        } else if (mDefaultBtRemoteType.contains("Amlogic_RC_QW")) {
            remoteImg.setImageDrawable(mContext.getDrawable(R.drawable.remote_press_light_qw));
            mTextStatus.setText(STR_TIP_QW);
        }
