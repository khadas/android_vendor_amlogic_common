...
public class DroidlogicApplication extends Application {
    ...
    private void startPowerService() {
        String POWER_SERVICE_PACKEGE_NAME = "com.droidlogic";
        String POWER_SERVICE_NAME = "com.droidlogic.DroidLogicPowerService";
        if (DroidLogicUtils.isTv())
            startDroidLogicServices(POWER_SERVICE_PACKEGE_NAME, POWER_SERVICE_NAME);
    }
