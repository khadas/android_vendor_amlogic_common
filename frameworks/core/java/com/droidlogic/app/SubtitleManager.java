...
public class SubtitleManager {
    ...
    static public final int SUBTITLE_VCHIP_FLAG = -2;
    ...
    public static final int TT_EVENT_QUICK_NAVIGATE_RED = 0;
    public static final int TT_EVENT_QUICK_NAVIGATE_GREEN = 1;
    public static final int TT_EVENT_QUICK_NAVIGATE_YELLOW = 2;
    public static final int TT_EVENT_QUICK_NAVIGATE_BLUE = 3;
    // The ten numeric keys used to input page indexes.
    public static final int TT_EVENT_0 = 4;
    public static final int TT_EVENT_1 = 5;
    public static final int TT_EVENT_2 = 6;
    public static final int TT_EVENT_3 = 7;
    public static final int TT_EVENT_4 = 8;
    public static final int TT_EVENT_5 = 9;
    public static final int TT_EVENT_6 = 10;
    public static final int TT_EVENT_7 = 11;
    public static final int TT_EVENT_8 = 12;
    public static final int TT_EVENT_9 = 13;
    // This is the home key, which returns to the nominated index page for this service.
    public static final int TT_EVENT_INDEXPAGE = 14;
    // These are used to quickly increment/decrement the page index.
    public static final int TT_EVENT_NEXTPAGE = 15;
    public static final int TT_EVENT_PREVIOUSPAGE = 16;
    // These are used to navigate the sub-pages when in 'hold' mode.
    public static final int TT_EVENT_NEXTSUBPAGE = 17;
    public static final int TT_EVENT_PREVIOUSSUBPAGE = 18;
    // These are used to traverse the page history (if caching requested).
    public static final int TT_EVENT_BACKPAGE = 19;
    public static final int TT_EVENT_FORWARDPAGE = 20;
    // This is used to toggle hold on the current page.
    public static final int TT_EVENT_HOLD = 21;
    // Reveal hidden page content (as defined in EBU specification)
    public static final int TT_EVENT_REVEAL = 22;
    // This key toggles 'clear' mode (page hidden until updated)
    public static final int TT_EVENT_CLEAR = 23;
    // This key toggles 'clock only' mode (page hidden until updated)
    public static final int TT_EVENT_CLOCK = 24;
    // Used to toggle transparent background ('video mix' mode)
    public static final int TT_EVENT_MIX_VIDEO = 25;
    // Used to toggle double height top / double-height bottom / normal height display.
    public static final int TT_EVENT_DOUBLE_HEIGHT = 26;
    // Functional enhancement may offer finer scrolling of double-height display.
    public static final int TT_EVENT_DOUBLE_SCROLL_UP = 27;
    public static final int TT_EVENT_DOUBLE_SCROLL_DOWN = 28;
    // Used to initiate/cancel 'timer' mode (clear and re-display page at set time)
    public static final int TT_EVENT_TIMER = 29;
...
//    private native void nativeSetIoType(int type);
    ...
    private native void nativeSubtitleTune(int type, int param1, int param2, int param3);
    ...
    /*idx: may be include extsub and internal sub
      default ext sub index first and then internal sub index
    ...
    */
    public void openIdx(int idx) {
        ...
        if (idx < innerTotal() && mIOType == IO_TYPE_FMQ && mMediaPlayer != null) {
            close();
            LOGI("[openIdx] subtitle track switch idx:" + idx);
            nativeOpen(null, IO_TYPE_FMQ);
            nativeResetForSeek();
        ...
        if (mPath != null) {
            try {
                ...
                if (mSubtitleUtils.getSubID(0) != null) {
                    iotype = IO_TYPE_FILE;
                    mExtFilePath = mSubtitleUtils.getSubID(0).mFileName;
                    LOGI("[start]ext sub path:" + mExtFilePath);
                }
                mExtFilePath = mExtFilePath == null ? mPath : mExtFilePath;
                result = open(mExtFilePath, iotype);
                LOGI("[start]ext sub innerTotal:" + innerTotal());
            } catch (Exception e) {
                Log.e(TAG, "Exception:" + e);
            }
...
*/
    ...
    public int ttControl(int teletxtEvent, int magazine, int page) {
        return nativeTtControl(teletxtEvent, magazine, page, 0);
    }
    ...
    public void SubtitleTune(int type, int param1, int param2, int param3) {
        Log.d(TAG, "SubtitleTune= " + type + " " + param1);
        nativeSubtitleTune(type, param1, param2, param3);
    }
