...
public class FileListManager {
    ...
    public static final String KEY_FS_TYPE = "key_fs_type";
    public static final String KEY_VOLUME_ID = "key_volume_id";
    public static final String KEY_DISK_ID = "key_disk_id";
        ...
        try {
            ...
            for (Object vol : volumes) {
                if (vol != null && (boolean)isMountedReadable.invoke(vol) && (int)getType.invoke(vol) == 0) {
                    ...
                    map.put(KEY_SELE, SELE_NO);
                    map.put(KEY_RDWR, null);
                    map.put(KEY_FS_TYPE, fsTypeStr);
                    map.put(KEY_VOLUME_ID, volumeIdStr);
                    map.put(KEY_DISK_ID, diskIdStr);
