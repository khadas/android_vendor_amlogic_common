...
public class PppoeStateTracker /*implements NetworkStateTracker*/ {
    ...
    public static final String PROP_PPP_ADDR = "dhcp.ppp0.ipaddress";
    public static final String PROP_PPP_MASK = "dhcp.ppp0.mask";
    ...
    private boolean configureInterfaceStatic(String ifname, DhcpInfoInternal dhcpInfoInternal) {
        ...
        if (DetailedState.CONNECTED != mLastState) {
            try {
