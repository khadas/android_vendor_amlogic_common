...
class HdmiCecActionCallback: virtual public RefBase {
public:
    // Return true means the hdmi cec event has been consumed, no need to continue to transfer.
    virtual bool onAction(hdmi_cec_action_type action, const hdmi_cec_event_t* event) = 0;
};
