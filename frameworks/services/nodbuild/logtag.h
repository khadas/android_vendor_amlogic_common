...
#define SYS_LOGE(x...)      KLOG_ERROR("nodbuild", x)
#define SYS_LOGD(x...)      KLOG_DEBUG("nodbuild", x)
#define SYS_LOGV(x...)      KLOG_NOTICE("nodbuild", x)
#define SYS_LOGI(x...)      KLOG_INFO("nobuild", x)
#else
#include <log/log.h>
