...
bool SysWrite::writeHdcpRX14Key(const char *value, const int size){
    #ifndef RECOVERY_MODE
        return keyProvisionStore(value, size);
    #endif
    return false;
...
bool SysWrite::writeHdcpRX22Key(const char *value, const int size){
    #ifndef RECOVERY_MODE
        return keyProvisionStore(value, size);
    #endif
    return false;
...
bool SysWrite::readHdcpRX14Key(const uint32_t key_type, int size) {
    bool ret = false;
    #ifndef RECOVERY_MODE
        ret = keyProvisionQuery(key_type, size);
    #endif
...
bool SysWrite::readHdcpRX22Key(const uint32_t key_type, int size) {
    bool ret = false;
    #ifndef RECOVERY_MODE
        ret = keyProvisionQuery(key_type, size);
    #endif
