...
Return<void> SystemControlHal::getOverscanParams(int32_t mode, getOverscanParams_cb _hidl_cb) {
    tvin_cutwin_t tempParam = mSysControl->getOverscanParams(mode);
    OverScanParam param;
