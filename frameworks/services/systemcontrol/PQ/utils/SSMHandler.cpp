...
struct SSMHeader_section2_t gSSMHeader_section2[] = {
    ...
    {.id =VPP_DATA_POS_RGB_GAIN_R_START, .addr = 0, .size = 4 * SSM_TEMPERATURE_MODE_MAX, .valid = 0, .rsv = {0}},
    {.id =VPP_DATA_POS_RGB_GAIN_G_START, .addr = 0, .size = 4 * SSM_TEMPERATURE_MODE_MAX, .valid = 0, .rsv = {0}},
    {.id =VPP_DATA_POS_RGB_GAIN_B_START, .addr = 0, .size = 4 * SSM_TEMPERATURE_MODE_MAX, .valid = 0, .rsv = {0}},
    {.id =VPP_DATA_POS_RGB_POST_OFFSET_R_START, .addr = 0, .size = 4 * SSM_TEMPERATURE_MODE_MAX, .valid = 0, .rsv = {0}},
    {.id =VPP_DATA_POS_RGB_POST_OFFSET_G_START, .addr = 0, .size = 4 * SSM_TEMPERATURE_MODE_MAX, .valid = 0, .rsv = {0}},
    {.id =VPP_DATA_POS_RGB_POST_OFFSET_B_START, .addr = 0, .size = 4 * SSM_TEMPERATURE_MODE_MAX, .valid = 0, .rsv = {0}},
    ...
    {.id =298, .addr = 0, .size = 0, .valid = 0, .rsv = {0}},
    {.id =299, .addr = 0, .size = 0, .valid = 0, .rsv = {0}},
    ...
    {.id =VPP_DATA_POS_MEMC_DEBLUR_LEVEL_START, .addr = 0, .size = SSM_SOURCE_MAX * 5, .valid = 0, .rsv = {0}},
    {.id =VPP_DATA_POS_MEMC_DEJUDDER_LEVEL_START, .addr = 0, .size = SSM_SOURCE_MAX * 5, .valid = 0, .rsv = {0}},
