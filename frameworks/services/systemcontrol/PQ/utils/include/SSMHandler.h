...
enum{
    ...
    VPP_DATA_POS_DLG_ENABLE_START = 214,
    VPP_DATA_POS_VRR_ENABLE_START = 215,
    SSM_RSV3 = 250,
    ...
    CUSTOMER_DATA_POS_HDMI_QMS_ENABLE_START = 295,
    VPP_DATA_POS_MEMC_MODE_START = 302,
    VPP_DATA_POS_MEMC_DEBLUR_LEVEL_START = 303,
    VPP_DATA_POS_MEMC_DEJUDDER_LEVEL_START = 304,
    VPP_DATA_POS_AISR_ENABLE_START = 305,
    VPP_DATA_POS_BLACK_STRETCH_START = 306,
    VPP_DATA_POS_BLUE_STRETCH_START = 307,
    VPP_DATA_POS_CHROMA_CORING_START = 308,
    VPP_DATA_POS_LOCAL_DIMMING_START = 309,
    VPP_DATA_POS_PICTURE_MODE_PARAM_START = 310,
    VPP_DATA_POS_PICTURE_MODE_PARAM_CRC_START = 311,
    VPP_DATA_POS_AISR_MODE_START = 312,
    ...
    VPP_DATA_POS_WB_GAMMA_PARAM_START = 317,
    SSM_DATA_MAX,
};
...
typedef enum SSM_picture_mode_e {
    SSM_PICTURE_MODE_STANDARD = 0,
    SSM_PICTURE_MODE_BRIGHT,
    SSM_PICTURE_MODE_SOFT,
    SSM_PICTURE_MODE_USER,
    SSM_PICTURE_MODE_MOVIE,
    SSM_PICTURE_MODE_COLORFUL,
    SSM_PICTURE_MODE_MONITOR,
    SSM_PICTURE_MODE_GAME,
    SSM_PICTURE_MODE_SPORTS,
    SSM_PICTURE_MODE_SONY,
    SSM_PICTURE_MODE_SAMSUNG,
...
typedef enum SSM_temperature_mode_e {
    ...
    SSM_TEMPERATURE_MODE_WARM,
    SSM_TEMPERATURE_MODE_COLD,
    SSM_TEMPERATURE_MODE_USER,
    SSM_TEMPERATURE_MODE_MAX,
} SSM_temperature_mode_t;
