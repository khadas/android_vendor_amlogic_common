...
typedef enum di_deblock_mode_e {
    DI_DEBLOCK_MODE_OFF,
    DI_DEBLOCK_MODE_LOW,
    DI_DEBLOCK_MODE_MIDDLE,
    DI_DEBLOCK_MODE_HIGH,
    DI_DEBLOCK_MODE_AUTO,
} di_deblock_mode_t;

typedef enum di_demosquito_mode_e {
    DI_DEMOSQUITO_MODE_OFF,
    DI_DEMOSQUITO_MODE_LOW,
    DI_DEMOSQUITO_MODE_MIDDLE,
    DI_DEMOSQUITO_MODE_HIGH,
    DI_DEMOSQUITO_MODE_AUTO,
} di_demosquito_mode_t;
...
typedef enum vpp_display_mode_e {
    ...
    VPP_DISPLAY_MODE_FULL_STRETCH,
    VPP_DISPLAY_MODE_43_IGNORE,
    VPP_DISPLAY_MODE_43_LETTER_BOX,
    VPP_DISPLAY_MODE_43_PAN_SCAN,
    VPP_DISPLAY_MODE_43_COMBINED,
    VPP_DISPLAY_MODE_169_IGNORE,
    VPP_DISPLAY_MODE_169_LETTER_BOX,
    VPP_DISPLAY_MODE_169_PAN_SCAN,
    VPP_DISPLAY_MODE_169_COMBINED,
...
typedef enum black_extension_mode_e
{
    BLACK_EXTENSION_MODE_OFF = 0,
    BLACK_EXTENSION_MODE_LOW,
    BLACK_EXTENSION_MODE_MID,
    BLACK_EXTENSION_MODE_HIGH,
    BLACK_EXTENSION_MODE_MAX,
} black_extension_mode_t;
