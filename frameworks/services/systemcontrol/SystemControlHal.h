...
class SystemControlHal : public ISystemControl, public SystemControlNotify, public PqNotify {
  public:
    ...
    Return<void> getColorSpaceList(getColorSpaceList_cb _hidl_cb) override;
    ...
    Return<void> readSysfsOri(const hidl_string &path, readSysfs_cb _hidl_cb) override;
    ...
    Return<void> setALLMState(int32_t state) override;
    Return<void> sendHDMIContentType(int32_t state) override;
    Return<bool> getAllmSupport(void) override;
    Return<bool> getGameContentTypeSupport(void) override;
    ...
    Return<void> getHdrPriority(getHdrPriority_cb _hidl_cb) override;
    ...
    Return<int32_t> getLastPQmode(void)  override;
    ...
    Return<int32_t> setMemcDeBlurLevel(int32_t level, int32_t isSave) override;
    Return<int32_t> getMemcDeBlurLevel(void) override;
    Return<int32_t> setMemcDeJudderLevel(int32_t level, int32_t isSave) override;
    Return<int32_t> getMemcDeJudderLevel(void) override;
    ...
    Return<int32_t> getLocalContrastMode(void) override;
    Return<int32_t> setBlackExtensionMode(int32_t mode, int32_t isSave) override;
    Return<int32_t> getBlackExtensionMode(void) override;
    Return<int32_t> setDeblockMode(int32_t mode, int32_t isSave) override;
    Return<int32_t> getDeblockMode(void) override;
    Return<int32_t> setDemoSquitoMode(int32_t mode, int32_t isSave) override;
    ...
    Return<int32_t> setCurrentAspectRatioInfo(int32_t aspectRatioInfo) override;
    ...
    //screen color
    Return<int32_t> setScreenColorForSignalChange(int32_t screenColor, int32_t isSave);
    ...
    //density
    Return<Result> syncDensity(int displayId, int width, int height);
