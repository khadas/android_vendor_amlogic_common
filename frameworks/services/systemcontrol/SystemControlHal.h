...
class SystemControlHal : public ISystemControl, public SystemControlNotify, public PqNotify {
  public:
    ...
    Return<Result> scCpyFile(const hidl_string& src,const hidl_string& dest, bool usethread) override;
    ...
    Return<int32_t> setAudioParam(int32_t param1, int32_t param2, int32_t param3, int32_t param4);
