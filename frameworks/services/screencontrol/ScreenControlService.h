...
public:
    static sp<ScreenControlService>& getInstance();
    ...
    int32_t startYuvRecord(int32_t left, int32_t top, int32_t right, int32_t bottom, int32_t width, int32_t height,
                           int32_t frameRate, int32_t sourceType);
