...
namespace  TvEvent {
    ...
    public:
        ...
        static const int EVENT_AV_PLAYER_BLOCKED = 10;
        static const int EVENT_AV_PLAYER_UNBLOCK = 11;

        int mMsgType;
        int mProgramId;
    };

    class PlayerInstanceEvent:public CTvEv {
        public:
            PlayerInstanceEvent():CTvEv ( CTvEv::TV_EVENT_PLAY_INSTANCE )
            {
                mMsgType = 0;
                type = 0;
                id = 0;
    ...
    public:
        ...
        ~ResourceManEvent(){}
        static const int EVENT_RES_ON_PREEMT = 0x01;
        int cmd;
    };
