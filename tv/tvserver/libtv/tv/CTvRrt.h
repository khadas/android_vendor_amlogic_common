...
static const char *TV_RRT_DEFINE_SYSTEM_PATH_0 = "odm/etc/tvconfig/tv_rrt_define.xml";
static const char *TV_RRT_DEFINE_SYSTEM_PATH_1 = "/mnt/vendor/odm_ext/etc/tvconfig/tv_rrt_define.xml";

#if ANDROID_PLATFORM_SDK_VERSION >= 28
#define TV_RRT_DEFINE_PARAM_PATH          "/mnt/vendor/odm_ext/vendor/param/tv_rrt_define.xml"
#else
