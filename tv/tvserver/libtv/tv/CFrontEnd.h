...
static const char *PATH_FE_TIMER_EN_49  = "/sys/module/aml_fe/parameters/aml_timer_en";
static const char *PATH_FE_SLOW_MODE_49 = "/sys/module/aml_fe/parameters/slow_mode";
...
public:
    ...
    static int SNR10ToSQI(int snr);
    static int StrengthToSSI(int strength);
