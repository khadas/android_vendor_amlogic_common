...
#define CTV_DATABASE_DEFAULT_XML_0        "odm/etc/tvconfig/tv_default.xml"
#define CTV_DATABASE_DEFAULT_XML_1        "/mnt/vendor/odm_ext/etc/tvconfig/tv_default.xml"
