...
//DI module
static const char *PATH_DI_MPEG2VDIN_EN_49           = "/sys/module/di/parameters/mpeg2vdin_en";
static const char *PATH_DI_MPEG2VDIN_EN_54           = "/sys/module/di/parameters/mpeg2vdin_en";
static const char *PATH_DI_START_FRAME_DROP_COUNT_49 = "/sys/module/di/parameters/start_frame_drop_count";
static const char *PATH_DI_START_FRAME_DROP_COUNT_54 = "/sys/module/aml_media/parameters/start_frame_drop_count";
static const char *PATH_DI_DET3D_EN                  = "/sys/module/di/parameters/det3d_en";
static const char *PATH_DI_BUF_MGR_MODE              = "/sys/module/di/parameters/buf_mgr_mode";
static const char *PATH_DI_BYPASS_HD                 = "/sys/module/di/parameters/bypass_hd";
static const char *PATH_DI_BYPASS_ALL                = "/sys/module/di/parameters/bypass_all";
static const char *PATH_DI_BYPASS_GET_BUF_THRESHOLD  = "/sys/module/di/parameters/bypass_get_buf_threshold";
static const char *PATH_DI_BYPASS_PROG               = "/sys/module/di/parameters/bypass_prog";
static const char *PATH_DI_BYPASS_DYNAMIC            = "/sys/module/di/parameters/bypass_dynamic";
//RDMA
static const char *PATH_RDMA_EN                      = "/sys/module/rdma/parameters/enable";
//VDIN
static const char *PATH_TVIN_BLACK_BAR_EN            = "/sys/module/tvin_vdin/parameters/black_bar_enable";
//VDEC
static const char *PATH_VDEC_H264MVC_VIEW_MODE       = "/sys/module/amvdec_h264mvc/parameters/view_mode";
//HDMIRX
static const char *PATH_HDMIRX_AUDS_RCV_STS_49       = "/sys/module/tvin_hdmirx/parameters/auds_rcv_sts";
static const char *PATH_HDMIRX_AUDS_RCV_STS_54       = "/sys/module/aml_media/parameters/auds_rcv_sts";
//AFE
static const char *PATH_AFE_DPHAS_EN_49              = "/sys/module/tvin_afe/parameters/enable_dphase";
...
//vdin add pc mode ioctrol id:
#define TVIN_IOC_S_PC_MODE          _IOW(TVIN_IOC_MAGIC, 0x50, unsigned int)
//vdin get source option:
#define TVIN_IOC_G_INPUT_TIMING     _IOW(TVIN_IOC_MAGIC, 0x52, struct tvin_format_s)
...
public:
    ...
    int VDIN_StopDec();
    int VDIN_GetSignalEventInfo ( struct vdin_event_info_s *SignalEventInfo );
    ...
    int VDIN_SetMonitorMode(pq_status_update_e mode);
    int VDIN_GetHdmiFormatInfo(tvin_format_s *sourceFormatInfo);
    bool Tvin_SupportResman();
    static void tvin_onResPreemtCallback(void* param);
    int Tvin_getResmanHandle();
    bool Resman_Request(int app_type, int res_type, int timeout);
    ...
    static tv_hdmi_port_id_t Tvin_GetHdmiPortIDBySourceInput ( tv_source_input_t source_input );
    ...
    class ResourceManEvent: public CTvEv {
    public:
        static const int EVENT_RESMAN_ONPREEMT = 0x01;

        ResourceManEvent(): CTvEv(CTvEv::TV_EVENT_TVIN_RES)
        {
            cmd =0;
        }
        ~ResourceManEvent()
    ...
    class CheckSourceValidEvent: public CTvEv {
    public:
        CheckSourceValidEvent() : CTvEv(CTvEv::TV_EVENT_CHECK_SOURCE_VALID)
        {
            cmd = 0;
            source = 0;
        }
    ...
    public:
        IObserver() {};
        virtual ~IObserver() {};
        virtual void onEvent(const ResourceManEvent &ev) = 0;
        virtual void onEvent(const CheckSourceValidEvent &ev) = 0;
    };
    ...
    void sendEvent(CheckSourceValidEvent &evt);

private:
    mutable Mutex mLock;
    mutable Mutex mPortLock;
    static CTvin *mInstance;
    int mAfeDevFd;
    int mVdin0DevFd;
    bool mSupportResman;
    bool mOnPreemtRegisted;
    int mResmanFd;
    IObserver *mpResObserver;
    bool m_snow_status;
