...
public:
    ...
    Return<int32_t> loadEdidData(int32_t isNeedBlackScreen, int32_t isDolbyVisionEnable) override;
    Return<int32_t> updateEdidData(int32_t inputSrc, const hidl_string& edidData) override;
    ...
    Return<void> getHdmiFormatInfo(getHdmiFormatInfo_cb _hidl_cb) override;
    ...
    Return<int32_t> setScreenColorForSignalChange(int32_t screenColor, int32_t is_save) override;
    Return<int32_t> getScreenColorForSignalChange() override;
    ...
    Return<int32_t> dtvGetSignalSNR() override;
