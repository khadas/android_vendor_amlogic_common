...
public class AV2InputService extends DroidLogicTvInputService {
    private static final String TAG = AV2InputService.class.getSimpleName();
    ...
    public Session onCreateSession(String inputId) {
        ...
        mCurrentSession = new AV2InputSession(this, inputId, getHardwareDeviceId(inputId));
    ...
    public String getDeviceClassName() {
        return AV2InputService.class.getName();
    }

    public int getDeviceSourceType() {
        return DroidLogicTvUtils.DEVICE_ID_AV2;
    }
}
