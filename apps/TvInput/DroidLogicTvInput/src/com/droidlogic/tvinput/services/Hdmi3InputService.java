...
public class Hdmi3InputService extends DroidLogicTvInputService {
    ...
    public Session onCreateSession(String inputId) {
        ...
        mCurrentSession = new Hdmi3InputSession(this, inputId, getHardwareDeviceId(inputId));
    ...
    public String getDeviceClassName() {
        return Hdmi3InputService.class.getName();
    }

    public int getDeviceSourceType() {
        return DroidLogicTvUtils.DEVICE_ID_HDMI3;
    }
}
