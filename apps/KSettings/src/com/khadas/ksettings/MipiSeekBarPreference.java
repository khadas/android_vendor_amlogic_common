...
public class MipiSeekBarPreference extends DialogPreference implements OnSeekBarChangeListener{
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_WHAT_SET_BACKLIGHT:
                    ...
                    try {
                        ComApi.execCommand(new String[]{"sh", "-c", "echo " + msg.arg1 +" > /sys/class/backlight/aml-bl/brightness"});
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    break;
    ...
    public MipiSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
