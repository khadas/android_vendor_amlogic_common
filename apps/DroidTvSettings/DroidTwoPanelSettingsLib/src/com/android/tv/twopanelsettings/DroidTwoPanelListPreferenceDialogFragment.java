...
public class DroidTwoPanelListPreferenceDialogFragment extends LeanbackListPreferenceDialogFragment {
    ...
    public static DroidTwoPanelListPreferenceDialogFragment newInstanceSingle(String key) {
        ...
        final DroidTwoPanelListPreferenceDialogFragment
                fragment = new DroidTwoPanelListPreferenceDialogFragment();
    ...
    private class TwoPanelAdapterSingle extends RecyclerView.Adapter<ViewHolder>
        ...
        public void onItemClick(ViewHolder viewHolder) {
            ...
            if (getParentFragment() instanceof DroidTwoPanelSettingsFragment) {
                DroidTwoPanelSettingsFragment parent = (DroidTwoPanelSettingsFragment) getParentFragment();
                parent.navigateBack();
            }
