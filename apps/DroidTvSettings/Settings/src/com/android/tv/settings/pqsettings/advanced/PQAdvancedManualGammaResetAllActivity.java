...
public class PQAdvancedManualGammaResetAllActivity extends Activity {

    private static final String TAG = "PQAdvancedManualGammaResetAllActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            GuidedStepFragment.addAsRoot(this, PQAdvancedManualGammaFragmentResetAllFragment.newInstance(), android.R.id.content);
        }
    }

    public static class PQAdvancedManualGammaFragmentResetAllFragment extends GuidedStepFragment {

        public static PQAdvancedManualGammaFragmentResetAllFragment newInstance() {

            Bundle args = new Bundle();

            PQAdvancedManualGammaFragmentResetAllFragment fragment = new PQAdvancedManualGammaFragmentResetAllFragment();
        ...
        public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
            return new GuidanceStylist.Guidance(
                    getString(R.string.pq_advanced_manual_gamma_allreset_title),
                    getString(R.string.pq_advanced_manual_gamma_allreset_description),
                    null,
        ...
        public void onCreateActions(@NonNull List<GuidedAction> actions,
            ...
            actions.add(new GuidedAction.Builder(getContext())
                    ...
                    .title(getString(R.string.pq_advanced_manual_gamma_allreset_title))
                    .build());
        }
    ...
    public static class PQResetAllConfirmFragment extends GuidedStepFragment {
        ...
        public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
            return new GuidanceStylist.Guidance(
                    getString(R.string.pq_advanced_manual_gamma_allreset_title),
                    getString(R.string.pq_advanced_manual_gamma_allreset_confirm_description),
                    null,
                    getContext().getDrawable(R.drawable.ic_settings_backup_restore_132dp));
        }
