...
import com.android.tv.settings.connectivity.setup.EnterIdentityState; // DroidLogic modify
...
public class AddWifiNetworkActivity extends InstrumentedActivity
    ...
    private State mEnterIdentityState;  // DroidLogic modify
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEnterIdentityState = new EnterIdentityState(this);  // DroidLogic modify
