...
import com.android.tv.twopanelsettings.DroidTwoPanelSettingsFragment;
 ...
 */
public class DroidLeanbackPickerDialogFragment extends LeanbackPreferenceDialogFragment implements
        DroidTwoPanelSettingsFragment.NavigationCallback {

    private static final String EXTRA_PICKER_TYPE = "DroidLeanbackPickerDialogFragment.PickerType";
    private static final String TYPE_DATE = "date";
    private static final String TYPE_TIME = "time";
    private static final String SAVE_STATE_TITLE = "DroidLeanbackPickerDialogFragment.title";
     ...
     */
    public static DroidLeanbackPickerDialogFragment newDatePickerInstance(String key) {
        final Bundle args = new Bundle(1);
        args.putString(ARG_KEY, key);
        args.putString(EXTRA_PICKER_TYPE, TYPE_DATE);

        final DroidLeanbackPickerDialogFragment fragment = new DroidLeanbackPickerDialogFragment();
     ...
     */
    public static DroidLeanbackPickerDialogFragment newTimePickerInstance(String key) {
        final Bundle args = new Bundle(1);
        args.putString(ARG_KEY, key);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (pickerType.equals(TYPE_DATE)) {
            ...
            datePicker.setOnClickListener(v -> {
                ...
                if (getParentFragment() instanceof DroidTwoPanelSettingsFragment) {
                    ((DroidTwoPanelSettingsFragment) getParentFragment()).navigateBack();
