...
public class WifiSecurityUtil {
    ...
    public static int getSecurity(WifiConfiguration config) {
        if (config.allowedKeyManagement.get(WifiConfiguration.KeyMgmt.SAE)) { // DroidLogic modify SWPL-45229
            return AccessPoint.SECURITY_SAE;
        }
    ...
    public static String getName(Context context, int wifiSecurity) {
        switch (wifiSecurity) {
            case AccessPoint.SECURITY_SAE:
                return context.getString(R.string.wifi_security_type_sae);// DroidLogic modify SWPL-45229
