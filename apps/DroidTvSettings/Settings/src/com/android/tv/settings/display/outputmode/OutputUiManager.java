        ...
        for (int i = 0; i < mHdmiValueList.length; i++) {
            if (mHdmiValueList[i] != null) {
                ...
                if (mOutputModeManager.getFrameRateOffset().contains("1")) {
                    if (mHdmiTitleList[i].contains("60hz")) {
                        listTitle.add(mHdmiTitleList[i].replace("60hz", "59.94hz"));
                    } else if (mHdmiTitleList[i].contains("30hz")) {
                        listTitle.add(mHdmiTitleList[i].replace("30hz", "29.97hz"));
                    } else if (mHdmiTitleList[i].contains("24hz")) {
                        listTitle.add(mHdmiTitleList[i].replace("24hz", "23.976hz"));
                    } else {
