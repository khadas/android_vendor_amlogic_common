 ...
 */
public class EnterIdentityState implements State {
    private final FragmentActivity mActivity;
    private Fragment mFragment;

    public EnterIdentityState(FragmentActivity activity) {
        mActivity = activity;
    }

    @Override
    public void processForward() {
        mFragment = new EnterIdentityFragment();
     ...
     */
    public static class EnterIdentityFragment extends WifiConnectivityGuidedStepFragment {
        ...
        public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
            return new GuidanceStylist.Guidance(
                    getString(R.string.title_identity),
                    null,
                    null,
                    null);
        }
        ...
        public void onCreateActions(@NonNull List<GuidedAction> actions,
            ...
            mAction = new GuidedAction.Builder(context)
                    .editable(true)
                    .title(prevIdendity == null ? "" : prevIdendity)
                    .build();
            actions.add(mAction);
        }
        ...
        public long onGuidedActionEditedAndProceed(GuidedAction action) {
            mUserChoiceInfo.put(UserChoiceInfo.IDENTITY, action.getTitle().toString());
