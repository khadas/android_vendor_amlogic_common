...
import android.net.wifi.WifiEnterpriseConfig;  //DroidLogic modify
...
public class WifiSecurityHelper {
    ...
    public static List<GuidedAction> getSecurityTypes(Context context) {
        ...
        securityTypes.add(new GuidedAction.Builder(context)
                ...
                .build());
        securityTypes.add(new GuidedAction.Builder(context)
                .title(context.getString(R.string.wifi_security_eap_wpa_wpa2))
                .id(AccessPoint.SECURITY_EAP)
                .build());
    ...
    public static WifiConfiguration getConfig(FragmentActivity context) {
        ...
        String identity = userChoiceInfo.getPageSummary(UserChoiceInfo.IDENTITY);  //DroidLogic modify
        ...
        switch (accessPointSecurity) {
            ...
            case AccessPoint.SECURITY_OWE:
                ...
                break;
            case AccessPoint.SECURITY_EAP:  //DroidLogic modify
                ...
                config.enterpriseConfig.setAnonymousIdentity(identity);
                break;
